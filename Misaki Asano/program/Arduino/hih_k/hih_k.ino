...
#define Addr 0x27   // HIH6130 I2C address is 0x27(39)

uint8_t buffer[128] = {0};
uint8_t An[DATALEN]={0};  //An-1:認証情報
uint8_t Am[DATALEN]={0};  //An:認証情報
uint8_t Al[DATALEN]={0};  //An+1:認証情報
uint8_t Mn[DATALEN]={0};  //Mn-1:秘匿情報
uint8_t Mm[DATALEN]={0};  //Mn:秘匿情報
uint8_t Ml[DATALEN]={0};  //Mn+1:秘匿情報
...
///------------------------
 ...
 /*AnとMnをROMからget*/
  ...
  len = wifi.recv(buffer, sizeof(buffer), 100000);
       if (len > 0){
