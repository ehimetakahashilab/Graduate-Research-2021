...
int transfer_first(int sock,unsigned char A1[],unsigned char An_prev[]);
int transfer_n(int sock,unsigned char An[],unsigned char An_prev[],clock_t *sock_clock);
...
int main(void) {
  ...
  transfer_first(sock,A1,An_prev);
  ...
  while(cnt !=1000){
    ...
    transfer_n(sock,An,An_prev,&sock_clock);
...
int transfer_n(int sock,unsigned char An[],unsigned char An_prev[],clock_t *sock_clock) {
  ...
  *sock_clock += (e_time - s_time);
  ...
  //----------make beta---------- 
  xor(An_next,alpha,An,BUF_SIZE);//make An_next
